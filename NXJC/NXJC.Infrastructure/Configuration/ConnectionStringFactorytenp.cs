...
{
    public static class ConnectionStringFactorytenp
    {
        /// <summary>
        /// 以生产线ID为键的过程数据库名字典
        /// </summary>
        ...
        static ConnectionStringFactorytenp()
        {
        ...
        public static string GetByProductLineId(int productLineId)
        {
            ...
            string connectionString = String.Format(ApplicationSettingsFactory.GetApplicationSettings().ProcessDataConnectionString, catalog);
        ...
        public static string GetByFactoryId(int factoryID)
        {
            ...
            string connectionString =
                string.Format(ApplicationSettingsFactory.GetApplicationSettings().ProcessDataConnectionString, catalog);
            return connectionString;
        }
        ...
        private static string GetCatalogByProductLineId(int productLineId)
        {
            ...
            string connectionString = GetNXJCConnectionString();
