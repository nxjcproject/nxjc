<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_FormulaDayInformation.aspx.cs" Inherits="NXJC.UI.Web.PeakValleyFlat.FormulaDay" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "table_FormulaDayInformation.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
