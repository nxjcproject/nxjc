<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_AmmeterSummitLowFlatYearInformation.aspx.cs" Inherits="NXJC.UI.Web.PeakValleyFlat.table_ammeter_summit_low_flat_year" %>
  ...
  <link href="/Scripts/easyui/themes/gray/easyui.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "table_AmmeterSummitLowFlatYearInformation.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
...
<body>
    <table id="gridMain_CellEdit" class="easyui-datagrid" title="" style="width:850px;height:auto">
	</table>
</body>
</html>
