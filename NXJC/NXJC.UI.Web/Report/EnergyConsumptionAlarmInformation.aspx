<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnergyConsumptionAlarmInformation.aspx.cs" Inherits="NXJC.UI.Web.Report.table_EnergyConsumptionAlarm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "EnergyConsumptionAlarmInformation.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
...
<body>
    <table id="gridMain_CellEdit" class="easyui-datagrid" title="" style="width:490px;height:auto">
	</table>
</body>
</html>
