<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_FormulaGroupDayInformation.aspx.cs" Inherits="NXJC.UI.Web.ProcessTeam.table_FormulaGroupDayInformation" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "table_FormulaGroupDayInformation.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
...
<body>
    <table id="gridMain_CellEdit" class="easyui-datagrid" title="" style="width:420px;height:auto">
	</table>
</body>
</html>