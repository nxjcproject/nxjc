<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_ClinkerProductionLineMonthlyElectricityConsumptionInformation.aspx.cs" Inherits="NXJC.UI.Web.Report.ClinkerProductionLineMonthlyElectricityConsumption" %>
 ...
 <link href="/Scripts/easyui/themes/gray/easyui.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "table_ClinkerProductionLineMonthlyElectricityConsumptionInformation.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
