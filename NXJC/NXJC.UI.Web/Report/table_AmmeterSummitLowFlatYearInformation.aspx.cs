...
{
    public partial class table_ammeter_summit_low_flat_year : System.Web.UI.Page
    {
        ...
        public static string GetCompanyData()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                ...
                cmd.CommandText = "SELECT  KeyID,编号,设备名,峰期电耗,尖峰期电耗,谷期电耗,平期电耗,合计电耗 FROM table_AmmeterSummitLowFlatYear";                          //填写查询语句
            ...
            {
                ColumnText = new string[] { "ID", "编号", "设备名", "峰期电耗", "尖峰期电耗", "谷期电耗", "平期电耗", "合计电耗" },                                 //填写表头及宽度
                ColumnWidth = new int[] { 10, 100, 100, 100, 100, 100, 100, 100 },
