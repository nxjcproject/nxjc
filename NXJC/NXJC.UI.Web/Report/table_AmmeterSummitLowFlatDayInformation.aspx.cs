...
{
    public partial class table_ammeter_summit_low_flat_day : System.Web.UI.Page
    {
        ...
        public static string GetCompanyData()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                ...
                cmd.CommandText = "SELECT KeyId,编号,设备名,峰期电耗,尖峰期电耗,谷期电耗,平期电耗,合计电耗 FROM table_AmmeterSummitLowFlatDay";                          //填写查询语句
