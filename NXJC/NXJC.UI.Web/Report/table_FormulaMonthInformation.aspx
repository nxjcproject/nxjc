<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_FormulaMonthInformation.aspx.cs" Inherits="NXJC.UI.Web.PeakValleyFlat.FormulaMonth" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "table_FormulaMonthInformation.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
