<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_AmmeterSummitLowFlatDayInformation.aspx.cs" Inherits="NXJC.UI.Web.PeakValleyFlat.table_ammeter_summit_low_flat_day" %>
   ...
   <link href="/Scripts/easyui/themes/gray/easyui.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function loadGridData(myLoadType) {
            ...
            $.ajax({
                type: "POST",
                url: "table_AmmeterSummitLowFlatDayInformation.aspx/GetCompanyData",                 //填写后台方法链接
                data: "",//"{id: ''}",
