<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="table_FormulaYearInformation.aspx.cs" Inherits="NXJC.UI.Web.Report.FormulaYearInformation" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function InitializeTZTxt(myData) {
            ...
            $('#txtModifier').val(myData['ModifierName']);
...
<body>
	                ...
	                <td>--%>
		                <table>
	                        <tr>
                                ...
                                <td><a href="#" class="easyui-linkbutton" data-options="plain:true" onclick="$('#dlg').dialog('open')">另存为</a>
                                </td>
        ...
        <div id="dlg" class="easyui-dialog" title="修改信息" style="width:400px;height:200px;padding:10px"
			    data-options="
				    iconCls: 'icon-save',
                    closed:true,
				    buttons: [{
            ...
            <div>
                <table style="width:95%;height:70px;">
                    <tr>
                        <td style="width:15%;">修改人：</td>
                        <td style="width:80%;"><input id="txtModifier" style="width: 100px;" /></td>
                    </tr>
                    <tr>
                        <td>备注：</td>
                        <td><textarea id="txtRemarks" style="width:100%;height:50px;padding:10px" ></textarea></td>
                    </tr>
                </table>
            </div>
	    </div>
